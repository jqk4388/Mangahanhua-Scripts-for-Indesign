...
| 脚本名称 | 功能描述 |
|---------|----------|
| 导入导出/导出报告/导出主页应用报告.jsx | 导出主页应用报告 |
| 导入导出/导出报告/导出主页覆盖选项报告.jsx | 导出主页覆盖选项报告 |
| 导入导出/导出报告/导出字体和列表.jsx | 导出文档中使用的字体列表 |
| 导入导出/导出报告/收集文本带坐标导出ID2LPtxt.jsx | 导出带坐标信息的文本 |
| 导入导出/导出报告/高级查找_导出报告.jsx | 执行高级查找并导出报告 |

#### 扫描版心对齐
| 脚本名称 | 功能描述 |
|---------|----------|
| 导入导出/扫描版心对齐/detect_hanmen.py | 自动检测扫描漫画页版心位置，输出hanmen.json及调试叠加图 |
| 导入导出/扫描版心对齐/置入并对齐版心.jsx | 按hanmen.json将扫描图置入并与页面版心对齐，汇总特殊页提示人工检查 |
