...
// encloses the contexts of selected TextFrames in <angle brackets>
...
try { 
    KTUDoScriptAsUndoable(encloseTextInAngleBrackets(app.selection), "Enclose Text in Angle Brackets")
} catch(err) {
